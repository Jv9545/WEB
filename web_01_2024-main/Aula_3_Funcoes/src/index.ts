...
*/
function calculadora(v1: number, v2:number, op: string){
    switch(op){
        case "+":
            return v1 + v2;
            break;
...
console.log(calculadora(5, 3, "+")); // Saída esperada: 8
console.log(calculadora(10, 2, "-")); // Saída esperada: 8
console.log(calculadora(4, 5, "*")); // Saída esperada: 20
console.log(calculadora(10, 2, "/")); // Saída esperada: 5
